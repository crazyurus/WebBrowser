...
// CWebBrowserApp 自定义加载/保存方法

void CWebBrowserApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CWebBrowserApp::LoadCustomState()
{
}

void CWebBrowserApp::SaveCustomState()
{
}
...
{
    ShellExecute(this->m_hWnd,L"open", L"http://710161378.qzone.qq.com/", NULL, NULL, SW_SHOWNORMAL);
    *pResult = 0;
}
